...
_orig_build_csrf_report_func = None
...
# Conditional import to ensure compatibility of og.maintenance
try:
...
class ManageCSRFTracing(grok.View):
    ...
    def _assert_compatibility(self):
        if _orig_build_csrf_report_func is None:
            raise NotImplementedError(
                "This version of opengever.core doesn't have a "
                "new enough opengever.debug.protect yet.")
